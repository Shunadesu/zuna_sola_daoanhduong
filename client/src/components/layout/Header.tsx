        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <a
                href="tel:0909123456"
                className="flex items-center gap-2 bg-primary text-white px-5 py-2.5 rounded-full hover:bg-primary/90 transition-colors"
              >
          ...
          >
            <nav className="flex flex-col items-center gap-6 p-8">
              ...
              <motion.a
                ...
                href="tel:0909123456"
                className="mt-4 flex items-center gap-2 bg-primary text-white px-8 py-3 rounded-full"
              >
